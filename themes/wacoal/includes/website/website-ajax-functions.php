 ...
 */
 ...
 add_action('wp_ajax_nopriv_btemptd_search_ajax_pagination', 'Wacoal_Search_Ajax_pagination');
 add_action('wp_ajax_btemptd_search_ajax_pagination', 'Wacoal_Search_Ajax_pagination');
