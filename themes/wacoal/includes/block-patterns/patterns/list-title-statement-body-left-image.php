<?php
/**
 * List - Title + Statement + Body + Image (Left)
 */
return array(
 ...
 <div class="wp-block-group list-statment-image--wrapper img-left"><!-- wp:columns {"verticalAlignment":"center","className":"list-statment-image\u002d\u002dinner"} -->
