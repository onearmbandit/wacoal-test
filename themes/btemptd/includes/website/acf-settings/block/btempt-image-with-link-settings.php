...
acf_add_local_field_group(
    ...
    'fields' => array(
        array(
            'key' => 'field_5fa0f37018828',
            'label' => 'Select Review Format',
            'name' => 'select_review_format',
            'type' => 'select',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
            ...
            'choices' => array(
                'two_review' => 'Two Review',
                'one_review' => 'One Review',
            ),
            'default_value' => 'two_review',
            'allow_null' => 0,
            'multiple' => 0,
            'ui' => 0,
            'return_format' => 'value',
