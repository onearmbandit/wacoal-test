 ...
 */
return array(
	'title'      => __( 'product Gallery', 'btemptd' ),
 ...
 <p class="product-gallery--box__title"><a href="https://btemptd.wacoal-america.com/blog/" target="_blank" rel="noreferrer noopener">Product Gallery</a></p>
 <!-- /wp:paragraph -->

 <!-- wp:paragraph {"className":"product-gallery\u002d\u002dbox__size"} -->
 <p class="product-gallery--box__size">M</p>
 <!-- /wp:paragraph --></div>
 <!-- /wp:column -->
 ...
 <!-- wp:paragraph {"className":"product-gallery\u002d\u002dbox__size"} -->
 <p class="product-gallery--box__size">S</p>
 <!-- /wp:paragraph --></div>
 <!-- /wp:column -->
 ...
 <!-- wp:paragraph {"className":"product-gallery\u002d\u002dbox__size"} -->
 <p class="product-gallery--box__size">L</p>
 <!-- /wp:paragraph --></div>
 <!-- /wp:column -->
