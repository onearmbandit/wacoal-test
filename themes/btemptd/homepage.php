...
<section class="btemptd-101">
    <div class="btemptd-101--wrapper">
        <div class="btemptd-101--image">
            <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/btemptd-101-image.png" alt="btemptd 101" />
        </div>
        <div class="btemptd-101--content">
            ...
            <div class="btemptd-101--list">
                <div class="btemptd-101--list__icon">
                    <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/wacol-101-arrow.svg" alt="btemptd 101 Arrow" />
                </div>
                <div class="btemptd-101--list__content">Bra Finder</div>
            </div>
            <div class="btemptd-101--list">
                <div class="btemptd-101--list__icon">
                    <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/wacol-101-arrow.svg" alt="btemptd 101 Arrow" />
                </div>
                <div class="btemptd-101--list__content">Bra Fit Calculator</div>
            </div>
            <div class="btemptd-101--list">
                <div class="btemptd-101--list__icon">
                    <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/wacol-101-arrow.svg" alt="btemptd 101 Arrow" />
                </div>
                <div class="btemptd-101--list__content">Breast Shape Guide</div>
            </div>
            <div class="btemptd-101--list">
                <div class="btemptd-101--list__icon">
                    <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/wacol-101-arrow.svg" alt="btemptd 101 Arrow" />
                </div>
                <div class="btemptd-101--list__content">Size Charts</div>
            </div>
            <div class="btemptd-101--list">
                <div class="btemptd-101--list__icon">
                    <img src="<?php echo  esc_url(THEMEURI); ?>/assets/images/wacol-101-arrow.svg" alt="btemptd 101 Arrow" />
                </div>
                <div class="btemptd-101--list__content">Ask A Bra Fit Expert</div>
            </div>
        </div>
    </div>
</section>
