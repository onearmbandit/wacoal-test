...
/**
	@brief			Modify attachment IDs found in Gutenberg blocks to match their equivalent attachments on each blog.
	@plugin_group	Control
	@since			2019-06-19 16:56:42
**/
class Gutenberg_Attachments
